...
scores_df <- read.csv(file = 'data/scores.csv', stringsAsFactors = TRUE)
summary(scores_df)
...
voter_turnout_df2 <- read_excel('data/G04ResultsDetail2004-11-02.xls', "Voter Turnout", skip = 2, col_names = c("ward_precint", "ballots_cast", "registered_voters", "voter_turnout"))
